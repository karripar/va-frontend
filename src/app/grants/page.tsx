    ...
    <div className="min-h-screen bg-[var(--background)] text-[var(--foreground)]">
      <main className="mx-auto max-w-[1200px]">
        <section className="px-6 sm:px-10 lg:px-14 py-8">
          {/* Page header */}
          <div className="mb-4">
            <h1 className="text-3xl font-extrabold tracking-wide mx-auto max-w-5xl">
              Apurahat ja kustannukset
            </h1>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 max-w-5xl mx-auto">
            ...
            <div className="relative">
              ...
              >
                ...
                <option value="Nordplus">Nordplus</option>
              </select>
              <FiChevronDown className="pointer-events-none absolute right-3 top-1/2 -translate-y-1/2 text-neutral-600" />
            </div>
          </div>
          ...
          <div className="mt-6 max-w-5xl mx-auto">
            <div className="rounded-2xl border border-[var(--va-border)] bg-white shadow-sm p-6 md:p-8">
              <h2 className="font-semibold mb-5">Arvio apurasta</h2>
              {/* Numbers */}
              ...
              <div className="mt-5 flex items-center gap-4">
                ...
                <div className="text-xs text-neutral-600">1000€</div>
              </div>
              {/* Meta info */}
              <div className="mt-5 grid grid-cols-2 text-sm">
                <div className="text-neutral-500">Kohde</div>
                <div className="font-medium">Italia</div>
                <div className="text-neutral-500">Ohjelma</div>
              ...
              <div className="mt-7">
                <Link
                  href="#"
                  className="inline-flex items-center gap-2 rounded-full bg-[var(--va-orange)] text-white px-6 py-3.5 text-base font-bold shadow hover:brightness-95 focus-ring"
                >
                  Hae apurahaa
                  <FiExternalLink />
                </Link>
          ...
          <div className="mt-10 max-w-5xl mx-auto">
            <h3 className="font-semibold mb-3">Erasmus+ lisätuet</h3>
...
function ExtraCard({
  ...
  return (
    <div className="rounded-2xl border border-[var(--va-border)] bg-white shadow-sm overflow-hidden">
      <button
        className="w-full flex items-center justify-between px-5 py-3 text-left bg-[color-mix(in_oklab,var(--va-orange)_15%,white)]"
        onClick={onToggle}
        aria-expanded={open}
      ...
      >
        <div
          ref={contentRef}
          className="p-5 text-sm text-neutral-800 space-y-3"
        >
          {kind === 'travel' && (
            <>
              <p>
